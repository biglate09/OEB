...
(d=0)):"first"==b?d=0:"ก่อนหน้า"==b?(d=0<=e?d-e:0,0>d&&(d=0)):"ถัดไป"==b?d+e<f&&(d+=e):"last"==b?d=Math.floor((f-1)/e)*e:K(a,0,"Unknown paging action: "+b,5);b=a._iDisplayStart!==d;a._iDisplayStart=d;b&&(s(a,null,"page",[a]),c&&O(a));return b}function sb(a){return h("<div/>",{id:!a.aanFeatures.r?a.sTableId+"_processing":null,"class":a.oClasses.sProcessing}).html(a.oLanguage.sProcessing).insertBefore(a.nTable)[0]}function C(a,b){a.oFeatures.bProcessing&&h(a.aanFeatures.r).css("display",b?"block":"none");
...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"ถัดไป",sPrevious:"ก่อนหน้า"},sEmptyTable:"No data available in table",sInfo:"แสดง _START_ ถึง _END_ จาก _TOTAL_ ข้อมูล",sInfoEmpty:"แสดง 0 ถึง 0 จาก 0 ข้อมูล",sInfoFiltered:"(กรองจาก _MAX_ ข้อมูลทั้งหมด)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"แสดง _MENU_ ข้อมูล",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"ค้นหา :",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},
...
" ui-corner-tl ui-corner-tr",sJUIFooter:Yb+" ui-corner-bl ui-corner-br"});var Nb=m.ext.pager;h.extend(Nb,{simple:function(){return["ก่อนหน้า","ถัดไป"]},full:function(){return["first","ก่อนหน้า","ถัดไป","last"]},numbers:function(a,b){return[ia(a,b)]},simple_numbers:function(a,b){return["ก่อนหน้า",ia(a,b),"ถัดไป"]},full_numbers:function(a,b){return["first","ก่อนหน้า",ia(a,b),"ถัดไป","last"]},first_last_numbers:function(a,b){return["first",ia(a,b),"last"]},_numbers:ia,numbers_length:7});h.extend(!0,m.ext.renderer,
{pageButton:{_:function(a,b,c,d,e,f){var g=a.oClasses,j=a.oLanguage.oPaginate,i=a.oLanguage.oAria.paginate||{},m,l,p=0,r=function(b,d){var k,t,u,s,v=function(b){Va(a,b.data.action,true)};k=0;for(t=d.length;k<t;k++){s=d[k];if(h.isArray(s)){u=h("<"+(s.DT_el||"div")+"/>").appendTo(b);r(u,s)}else{m=null;l="";switch(s){case "ellipsis":b.append('<span class="ellipsis">&#x2026;</span>');break;case "first":m=j.sFirst;l=s+(e>0?"":" "+g.sPageButtonDisabled);break;case "ก่อนหน้า":m=j.sPrevious;l=s+(e>0?"":" "+
g.sPageButtonDisabled);break;case "ถัดไป":m=j.sNext;l=s+(e<f-1?"":" "+g.sPageButtonDisabled);break;case "last":m=j.sLast;l=s+(e<f-1?"":" "+g.sPageButtonDisabled);break;default:m=s+1;l=e===s?g.sPageButtonActive:""}if(m!==null){u=h("<a>",{"class":g.sPageButton+" "+l,"aria-controls":a.sTableId,"aria-label":i[s],"data-dt-idx":p,tabindex:a.iTabIndex,id:c===0&&typeof s==="string"?a.sTableId+"_"+s:null}).html(m).appendTo(b);Ya(u,{action:s},v);p++}}}},t;try{t=h(b).find(H.activeElement).data("dt-idx")}catch(u){}r(h(b).empty(),
